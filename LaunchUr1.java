...
public static void main(String[] args) {
	...
	driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("anup@gmail.com");
	...
	driver.findElement(By.id("createLeadForm_generalAddress1")).sendKeys("Kavery nagar,mettur");
